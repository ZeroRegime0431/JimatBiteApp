...
export default function CategoryVeganScreen() {
  ...
  const loadActiveFilters = async () => {
    try {
      ...
      if (filtersStr) {
        ...
        if (filters.active && (filters.categories.length === 0 || filters.categories.includes('vegan'))) {
  ...
  const applyFilters = async (filters: any) => {
    ...
    const result = await getMenuItems('vegan');
    let items: MenuItem[] = [];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        ...
        />
        <Pressable style={styles.filterButton} onPress={() => router.push({ pathname: '/filter-page', params: { category: 'vegan' } })}>
        ...
        <>
          ...
          <View style={styles.filterResultsContainer}>
            <View style={styles.filterHeader}>
              <Text style={styles.filterHeaderText}>Filtered Vegan Items</Text>
        ...
        >
          ...
          <View style={styles.whiteContentContainer}>
            ...
            <View style={styles.sortSection}>
              ...
              <Pressable style={styles.filterIconButton} onPress={() => router.push({ pathname: '/filter-page', params: { category: 'vegan' } })}>
            ...
            {loading ? (
              <View style={styles.loadingContainer}>
                <ActivityIndicator size="large" color="#4CAF50" />
                <Text style={styles.loadingText}>Loading vegan options...</Text>
              </View>
              ...
              <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>No vegan options found</Text>
              </View>
            ) : (
              foodItems.filter(item => 
                searchQuery === '' || 
