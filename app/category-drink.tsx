  ...
  const loadActiveFilters = async () => {
    try {
      ...
      if (filtersStr) {
        ...
        if (filters.active && (filters.categories.length === 0 || filters.categories.includes('drink'))) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        ...
        />
        <Pressable style={styles.filterButton} onPress={() => router.push({ pathname: '/filter-page', params: { category: 'drink' } })}>
        ...
        <>
          ...
          <View style={styles.filterResultsContainer}>
            <View style={styles.filterHeader}>
              <Text style={styles.filterHeaderText}>Filtered Drinks</Text>
        ...
        >
          ...
          <View style={styles.whiteContentContainer}>
            ...
            <View style={styles.sortSection}>
              ...
              <Pressable style={styles.filterIconButton} onPress={() => router.push({ pathname: '/filter-page', params: { category: 'drink' } })}>
