...
// Category icons
import DessertPressedSvg from '../assets/Category-Dessert/icons/dessertpressed.svg';
...
export default function CategoryDessertScreen() {
  ...
  const loadActiveFilters = async () => {
    try {
      ...
      if (filtersStr) {
        ...
        if (filters.active && (filters.categories.length === 0 || filters.categories.includes('dessert'))) {
  ...
  const applyFilters = async (filters: any) => {
    ...
    const result = await getMenuItems('dessert');
    let items: MenuItem[] = [];
  ...
  const categories: CategoryItem[] = [
    ...
    { id: '4', icon: DessertPressedSvg, label: 'Dessert', pressed: true },
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        ...
        />
        <Pressable style={styles.filterButton} onPress={() => router.push({ pathname: '/filter-page', params: { category: 'dessert' } })}>
        ...
        <>
          ...
          <View style={styles.filterResultsContainer}>
            <View style={styles.filterHeader}>
              <Text style={styles.filterHeaderText}>Filtered Desserts</Text>
        ...
        >
          ...
          <View style={styles.whiteContentContainer}>
            ...
            <View style={styles.sortSection}>
              ...
              <Pressable style={styles.filterIconButton} onPress={() => router.push({ pathname: '/filter-page', params: { category: 'dessert' } })}>
